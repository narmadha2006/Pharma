...
<head>
  ...
  <title>Home - NH PharmaCompany</title>
  <!-- Bootstrap CSS -->
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    <a class="navbar-brand" href="#">NH PharmaCompany</a>
  ...
  <div class="container mt-5">
    <div class="row">
      <div class="col-md-8">
        <h1>Welcome to NH PharmaCompany</h1>
        <p>Welcome to NH PharmaCompany, your trusted source for high-quality pharmaceutical products. We are dedicated to improving the health and well-being of our customers by providing safe and effective medications.</p>
  ...
  <footer class="bg-dark text-white text-center py-4 mt-5">
    <p>&copy; 2024 NH PharmaCompany NARMADHA S(212223220065)</p>
  </footer>
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>About NH PharmaCompany</title>
  <!-- Bootstrap CSS -->
  <link href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css" rel="stylesheet">
  <!-- Custom CSS -->
  <style>
  ...
  <div class="container mt-5">
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="card-deck">
          <div class="card">
            <img src="centrum.jpg" class="card-img-top" alt="Product 1">
            <div class="card-body">
              <h5 class="card-title">Product 1</h5>
              <p class="card-text">Centrum - Supports Overall Health,Radiance,Strong Bones and Immunity</p>
              <a href="#" class="btn btn-primary">Buy Now</a>
            </div>
          </div>
          <div class="card">
            <img src="cough.jpg" class="card-img-top" alt="Product 2">
            <div class="card-body">
              <h5 class="card-title">Product 2</h5>
              <p class="card-text">Dabur Honitus - Herbal Cough Remedy,Fast relief</p>
              <a href="#" class="btn btn-primary">Buy Now</a>
            </div>
          </div>
          <div class="card">
            ...
            <div class="card-body">
              ...
              <p class="card-text">Cholecalciferol Softgel Capsules USP Vitamin D3 tablets</p>
              <a href="#" class="btn btn-primary">Buy Now</a>
            </div>
          </div>
        </div>
...
<body>
  ...
  <div class="container mt-5">
    <div class="row">
      ...
      <div class="col-md-4">
        <h2>NH PharmaCompany</h2>
        <address>
          <strong>Address:</strong><br>
          123 ABC street, Chennai<br>
          India, 632007<br><br>
          <strong>Email:</strong><br>
          info@NH pharmacompany.com<br><br>
